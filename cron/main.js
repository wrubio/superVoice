...
// Method to update registros table
const tableUpdate = require('./update-voice');

// URL del REST API
const urlDB = 'http://ec2-3-82-102-13.compute-1.amazonaws.com:3000';
    ...
    return new Promise((resolve, reject) => {
        ...
        ffmpeg(audio).toFormat('mp3')
            ...
            .on('end', () => {
                ...
                logger.fatal('Final de la conversion del archivo tiempo: ' + resta);
                resolve({ ok: true });
            })
